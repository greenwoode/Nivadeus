package com.happy.nivadeus.manasystem.network;

import java.util.function.Supplier;

import com.happy.nivadeus.manasystem.data.ManaManager;
import com.happy.nivadeus.manasystem.data.PlayerManaProvider;
